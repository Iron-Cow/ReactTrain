...
export default function Menu() {
    const {menuItems, setMenuItems, addItemToCart} = useContext(CartContext);
        ...
        menuItems && <div id="meals">
            {menuItems.map((meal, idx) => {
                return <div key={meal.id} className="meal-item">
                    ...
                    <button onClick={() => addItemToCart(meal.id)} className="button meal-item-actions">
                        Add to Cart
                    </button>
                </div>
            })}

        </div> || <div id="meals"><p>Loading meals...</p></div>
    )
